        ...
        <div class="grid md:grid-cols-5 gap-10">
            <div class="md:col-span-2">
                <div class="max-w-xs">
                    ...
                    <p
                        class="mt-1 hidden md:block text-gray-600 dark:text-gray-400"
                    >
            ...
            <div class="md:col-span-3">
                ...
                >
                    ...
                    >
                        ...
                        >
                            <p class="text-gray-600 dark:text-gray-400">
                                Almost. You will have a limit of 10 videos per
                                month. If you need more, you can subscribe to a
                                plan.
                            </p>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        >
                            <p class="text-gray-600 dark:text-gray-400">
                                Yes, it works with all types of videos. The only
                                requirement is that the video is public and has
                                an URL... and that's it.
                            </p>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        >
                            <p class="text-gray-600 dark:text-gray-400">
                                In your browser, do a right button click and
                                select "Read aloud".
                            </p>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        >
                            <p class="text-gray-600 dark:text-gray-400">
                                There is a contact form in the footer of the
                                page for newsletter. Also you can send
                                suggestions at the box down below.
                            </p>
                        </div>
                    </div>
                </div>
