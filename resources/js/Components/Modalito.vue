...
<template>
    ...
    <div id="hs-modal-upgrade-to-pro"
        ...
        <div
            ...
            <div
                class="bg-white border border-gray-200 rounded-xl shadow-sm pointer-events-auto dark:bg-gray-800 dark:border-gray-700">
                <div class="p-4 sm:p-7">
                    <div class="text-center">
                        <h2 class="block text-xl sm:text-2xl font-semibold text-gray-800 dark:text-gray-200">Advanced
                            features</h2>
                    ...
                    <div class="mt-8 sm:mt-10 divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <div class="flex gap-x-7 py-5 first:pt-0 last:pb-0">
                            <svg class="flex-shrink-0 mt-1 size-7 text-gray-600 dark:text-gray-400"
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500">
                                    Use this feature when you want to put a product on sale or show savings off
                        ...
                        <div class="flex gap-x-7 py-5 first:pt-0 last:pb-0">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500">
                                    Automatically keep track of product availability and receive notifications when
