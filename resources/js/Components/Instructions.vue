...
<template>
    ...
    >
        <div class="relative p-6 md:p-16">
            ...
            >
                <div
                    class="mb-10 lg:mb-0 lg:col-span-6 lg:col-start-8 lg:order-2"
                >
                    <h2
                    ...
                    >
                        ...
                        >
                            <span class="flex">
                                <svg
                                    class="flex-shrink-0 mt-2 size-6 md:size-7 hs-tab-active:text-blue-600 text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-gray-200"
                        ...
                        >
                            <span class="flex">
                                ...
                                <span class="grow ms-6">
                                    ...
                                    <span
                                        class="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-gray-200"
                                        >Being logged, just paste the link into
                                        the upside input box.</span
                                    >
                                </span>
                            </span>
                        </button>
                        ...
                        >
                            <span class="flex">
                                ...
                                <span class="grow ms-6">
                                    <span
                                        class="block text-lg font-semibold hs-tab-active:text-blue-600 text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-gray-200"
                                        >Summary is in the works</span
                                    >
                                    <span
                                        class="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-gray-200"
                                        >Enjoy the magic powered by AI. You will
                                        recieve an prompt output that's a
                                        summarize of a youtube video.</span
                                    >
                                </span>
                            </span>
                        </button>
