<template>
    <div class="relative isolate overflow-hidden bg-gray-900 py-16 sm:py-24 lg:py-32">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
                <div class="max-w-xl lg:max-w-lg">
                    ...
                    <p class="mt-4 text-lg leading-8 text-gray-300">It's just free.</p>
                    <div class="mt-6 flex max-w-md gap-x-4 flex-wrap">
                        ...
                        <input id="email-address" name="email" type="email" autocomplete="email" required
                            ...
                            placeholder="Enter your email" v-model="email" @blur="validateEmail">
                        <button type="submit"
                            ...
                            :class="{ 'bg-red-500': emailError }">Subscribe</button>
                ...
                <dl class="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
                    <div class="flex flex-col items-start">
                        ...
                        <dd class="mt-2 leading-7 text-gray-400">Each week you will receive an upcoming articles,
                            reports,
                            reviews and more.</dd>
                    </div>
                    <div class="flex flex-col items-start">
                        ...
                        <dd class="mt-2 leading-7 text-gray-400">We are compromised to not spam your e-mail (not
                            really).
                        </dd>
                    </div>
                </dl>
        ...
        <div class="text-center">
            ...
            <div class="mt-3">
                <p class="text-gray-500">© Nelson Rivera. 2024 DAW. All rights reserved.</p>
            </div>
